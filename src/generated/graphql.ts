  ...
  GetAllBlogs: {
    ...
    data?: Array<{
      ...
      User?: {
        ...
        genero?: number | null
        id?: string | null
        montoTotalComprado?: number | null
        nombres?: string | null
...
export type GetAllBlogsCategoriaSlugQuery = {
  __typename?: 'Query'
...
export const GetAllBlogsCategoriaSlugDocument = gql`
  query GetAllBlogsCategoriaSlug(
    $slug: String
    $pagina: Int
    $numeroPagina: Int
    $estado: String
 ...
 * });
 */
export function useGetAllBlogsCategoriaSlugQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetAllBlogsCategoriaSlugQuery,
    GetAllBlogsCategoriaSlugQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    GetAllBlogsCategoriaSlugQuery,
    GetAllBlogsCategoriaSlugQueryVariables
  >(GetAllBlogsCategoriaSlugDocument, options)
}
export function useGetAllBlogsCategoriaSlugLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllBlogsCategoriaSlugQuery,
    GetAllBlogsCategoriaSlugQueryVariables
  >,
...
export type GetAllBlogsCategoriaSlugQueryHookResult = ReturnType<
  typeof useGetAllBlogsCategoriaSlugQuery
>
export type GetAllBlogsCategoriaSlugLazyQueryHookResult = ReturnType<
  typeof useGetAllBlogsCategoriaSlugLazyQuery
>
export type GetAllBlogsCategoriaSlugQueryResult = Apollo.QueryResult<
  GetAllBlogsCategoriaSlugQuery,
  GetAllBlogsCategoriaSlugQueryVariables
>
